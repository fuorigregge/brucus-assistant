...
DEFAULT_KEYWORD = '/home/pi/envs/brucuenv/lib/python3.7/site-packages/pvporcupine/resources/keyword_files/raspberrypi/hey pico_raspberrypi.ppn'
...
def main():    
    ...
    parser.add_argument('--keywords', help='comma-separated list of default keywords (%s)' % ', '.join(util.KEYWORDS))

    parser.add_argument('--keyword_file_paths', help='comma-separated absolute paths to keyword files', default=DEFAULT_KEYWORD)

    parser.add_argument('--library_path', help="absolute path to Porcupine's dynamic library", default=util.LIBRARY_PATH)

    parser.add_argument('--model_file_path', help='absolute path to model parameter file', default=util.MODEL_FILE_PATH)

    parser.add_argument('--sensitivities', help='detection sensitivity [0, 1]', default=0.5)

    parser.add_argument('--input_audio_device_index', help='index of input audio device', type=int, default=2)
